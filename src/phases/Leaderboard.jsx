...
export function LeaderboardParcial({ titulo, subtitulo, onSiguiente, labelBoton }) {
  const [participantes, setParticipantes] = useState([])
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center gap-8 px-10 py-12">
      <div className="text-center">
        <h2 className="text-4xl font-bold text-yellow-400">{titulo}</h2>
...
export function LeaderboardPlayer({ userId }) {
  ...
  return (
    <div className="h-full bg-gray-950 flex flex-col items-center
